...
const Skills = () => {
  ...
  return (
    <div className="mt-20" data-aos="fade-bottom" id="skills">
      <h1 className="text-4xl mb-10 font-bold text-center">Skills</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        <div className="border-2 rounded-xl shadow-xl bg-white">
          <h4 className="text-2xl font-medium text-center  pb-3 border-b-2 border-b-black text-black">Expertise</h4>
          ...
          <button className="bg-white text-black text-4xl mb-2 mt-6 text-center rounded-full py-2  px-2">
            ...
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">HTML</h1>
          </div>
          ...
          <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            ...
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">CSS</h1>
          </div>
          <div className="rounded-xl bg-yellow-500 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <IoLogoJavascript />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">JAVASCRIPT</h1>
          </div>
          <div className="rounded-xl bg-black flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <FaReact />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">REACT</h1>
          </div>
          <div className="rounded-xl bg-purple-600 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <RiTailwindCssFill />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4 text-center">TAILWIND CSS</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <SiJsonwebtokens />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">JWT</h1>
          </div>
          </div>
        </div>
        <div className=" border-2 h-full bg-white  rounded-xl shadow-xl ">
          <h4 className="text-2xl font-medium text-center pb-3 text-black border-b-2 border-b-black">Familiar</h4>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3 gap-3 py-5 px-5  ">
          <div className="rounded-xl bg-orange-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <RiNextjsFill />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">NEXT.JS</h1>
          </div>
          <div className="rounded-xl bg-green-500 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <FaNodeJs />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">NODE.JS</h1>
          </div>
          <div className="rounded-xl bg-black flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <SiExpress/>
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">EXPRESS</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <SiAxios />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">AXIOS</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <SiAxios />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">TANSTACK</h1>
          </div>
          <div className="rounded-xl bg-slate-600 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <SiMongodb />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">MONGODB</h1>
          </div>
          </div>
        </div>
        <div className=" border-2 h-full bg-white  rounded-xl shadow-xl">
          <h4 className="text-2xl font-medium text-center border-b-2 border-b-black text-black pb-3">Tools</h4>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3 gap-3 py-5 px-5  ">
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <VscVscode />
            </button>
            <h1  className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">VSCODE</h1>
          </div>
          <div className="rounded-xl bg-yellow-600 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
              <RiFirebaseFill />
            </button>
            <h1  className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">FIREBASE</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <FaGithub />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">GITHUB</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <FaGitAlt />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">SURGE</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <FaGitAlt />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">GIT</h1>
          </div>
          <div className="rounded-xl bg-pink-300 flex flex-col items-center justify-center">
            <button className="bg-white text-4xl mb-2 mt-6 text-black rounded-full py-2  px-2">
            <FaGitAlt />
            </button>
            <h1 className="text-xl font-medium lg:text-2xl lg:font-semibold mb-4">DEV Tool</h1>
          </div>
          </div>
        </div>
      </div>
