  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex justify-center gap-4 ">
        <img className="h-[450px] lg:h-[400px]  hidden lg:block" data-aos='fade-right' src="https://i.ibb.co.com/5GhH6jt/image-4.png"  alt="" />
      <div className="flex flex-col space-y-2  xl:ml-6" data-aos='fade-left'>
